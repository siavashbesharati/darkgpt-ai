...
import { Search, MoreHorizontal, UserCog, Ban, ShieldCheck, Mail, Zap, Trash2 } from 'lucide-react';
import { 
  DropdownMenu, 
  DropdownMenuContent, 
  DropdownMenuItem, 
...
export function UsersManagement() {
  ...
  const resetCredits = async (userId: string) => {
    try {
      ...
      if (res.ok) {
        toast.success("Credits reset to Free default");
        fetchUsers();
      }
    } catch (e) {
                  ...
                  <TableCell className="text-right pr-6">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end" className="w-56 bg-popover border-border">
                        ...
                        <DropdownMenuSeparator />
                        <DropdownMenuItem onClick={() => resetCredits(user.id)} className="cursor-pointer">
